...
//                 .param("size","15").param("page","1").param("sort","age,desc")
    ...
    public void uploadFile() throws Exception{
        ...
        String contentAsString = mockMvc.perform(MockMvcRequestBuilders.fileUpload("/file").file(new MockMultipartFile("file", "test.txt", "mutipart/form-data", "hello spootboot fileUpload".getBytes())))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn().getResponse().getContentAsString();
