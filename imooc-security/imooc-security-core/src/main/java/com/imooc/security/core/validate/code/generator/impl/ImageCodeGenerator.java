...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode create(ServletWebRequest request) {
        ...
        String sRand = "";
        for (int i = 0; i < securityProperties.getCode().getImage().getLength(); i++) {  //图片验证码的长度
        ...
        g.dispose();
        return new ImageCode(image, sRand, securityProperties.getCode().getImage().getExprireIn());
    }
